...
| **Pro**        | $99/user/month                      | Small to mid-sized teams (up to 50 users) | All Free Plan features, plus: <br><br>**V1 Features:<br>**Capacity Planning: Stay Ahead of Growth<br>
  Forecast Future Needs: Visualize historical data growth trends to accurately predict future storage requirements and avoid surprises.<br>
  Integrate & Monitor: Connect with external monitoring systems like OpenTelemetry for a unified view of your infrastructure's health.<br>
