...
export default function IntroducingOwlMaskVideoGuide() {
    return (
        <div className="flex flex-col gap-6">
            ...
            <h2 className="mt-6 text-3xl font-bold tracking-normal text-white">Walkthrough Sections</h2>
            <ul className="flex list-disc flex-col gap-3 pl-6 text-slate-300">
                <li><strong>Why safe test data matters:</strong> The operational and compliance reasons to mask before data reaches lower environments.</li>
                <li><strong>Connecting your database:</strong> How to securely connect OwlMask to your source databases.</li>
                <li><strong>Defining masking rules:</strong> A practical look at deterministic masking, format-preserving transformations, and custom rule creation.</li>
                <li><strong>Execution and validation:</strong> Running your first masking job and verifying output integrity.</li>
            </ul>
